...
public class DHeapTester {
    ...
    private ALDAHeap<Integer> heap = new ALDAHeap<Integer>(4);
    ...
    public void testConstructors() {
        heap = new ALDAHeap<Integer>(); // Skapar en binärheap
        heap = new ALDAHeap<Integer>(2); // Skapar ytterligare en binärheap
        heap = new ALDAHeap<Integer>(3); // Skapar en 3-heap, dvs en heap där varje
        // nod har 3 barn
    }

    @Test(expected = IllegalArgumentException.class)
    public void testTooSmallD() {
        new ALDAHeap<Integer>(1);
    }
